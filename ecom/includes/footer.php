		...
		<div class="row">
			<div class="col-md-3 col-sm-6"> <!--col-md-3 col-sm-6 start-->
              ...
              if(!isset($_SESSION['customer_email'])){
                 ...
                 echo "<a href='customer/my_account.php?edit_act'>Edit Account</a>";
              }
              ?>
					</li>
				</ul>
			...
			<div class="col-md-3 col-sm-6"><!--col-md-3 col-sm-6 start-->
				...
				<p>
					<strong>Web: www.aryatex-sourcing.com</strong>
					<strong>Corporate Office:</strong>
					<br>House# 16,Level #6, Road# 2B
					<br>Sector# 04, Uttara,Dhaka-1230
					<br>Email: adc@aryatex-sourcing.com
					<br>Phone:+880248953148
				</p>
