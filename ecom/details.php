...
<body>
   ...
   <div class="navbar navbar-default" id="navbar"> <!--navbar navbar-default Start-->
   	<div class="container">
          ...
          <img src="images/arlogo.jpg" alt="Astha Online Shop" class="hidden-xs">
  				</a> 
     ...
     <div class="container"> <!--Container Start-->
       ...
       <div class="col-md-9">
         ...
         <div class="box" id="details">
           ...
           <p>This is made with 100 % soft fabrics.You will feel comfort by wearing this.All the exclusive collection you will get here.</p>
           <h4>Size</h4>
           <ul>
             <li>Small</li>
             <li>Medium</li>
